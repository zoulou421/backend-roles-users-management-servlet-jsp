...
@ServerEndpoint("/websocket/endpoint2")
public class WebSocketServerUpdate2 {
	private static final Logger logger = LoggerFactory.getLogger(WebSocketServerUpdate2.class);
